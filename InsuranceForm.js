      ...
      <Box paddingTop={10} paddingBottom={10}>
        <Container>
          <Grid container spacing={3}>
            ...
            {send && (
              <Grid item xs={12}>
                <CustomAlert severity="success" title="Success">
                  Data sent successfully to ML model
                </CustomAlert>
              </Grid>
            )}
            ...
            <Grid item xs={12} md={6}>
              <Card>
                <CardContent>
                  ...
                  <TextField fullWidth label="BMI" name="bmi" onChange={handleChange} margin="normal" />

                  <TextField select fullWidth label="Sex" name="sex" onChange={handleChange} margin="normal">
                    <MenuItem value="0">Male</MenuItem>
                    <MenuItem value="1">Female</MenuItem>
                  </TextField>

                  <TextField fullWidth label="Children" name="children" onChange={handleChange} margin="normal" />

                  <TextField select fullWidth label="Smoker" name="smoker" onChange={handleChange} margin="normal">
                    <MenuItem value="0">Yes</MenuItem>
                    <MenuItem value="1">No</MenuItem>
                  </TextField>

                  <TextField select fullWidth label="Region" name="region" onChange={handleChange} margin="normal">
                    <MenuItem value="0">Southeast</MenuItem>
                    <MenuItem value="1">Southwest</MenuItem>
                    <MenuItem value="2">Northeast</MenuItem>
                    <MenuItem value="3">Northwest</MenuItem>
                ...
                <CardContent>
                  {result && (
                    <>
                      ...
                      <Typography variant="h3" align="center" sx={{ color: green[600] }}>
                        ₹ {prediction}
                      </Typography>
                    </>
                  )}
            ...
            <Grid item xs={12}>
              <EditorButtons submitOnClick={handleSubmit} />
            </Grid>
          </Grid>
        </Container>
      </Box>
